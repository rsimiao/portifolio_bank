...
namespace com.gft.creditSuisse.Domain.UnitTests
{
    ...
    class LowRiskStrategyTests
    {
        ...
        [TestCase(2_000_000)]
        public void LowRisk_ValueGreaterThanMilion_returnHighRiskIsTrue(double valor)
        {
        ...
        public void LowRisk_ValueEqualMilion_returnNotFound(double valor)
        {
            var t = new Trade() { Value = valor, ClientSector = "Public" };
            var risk = ContextRisk.Get(t).Categorize();
